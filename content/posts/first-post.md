...
As for Sword in Board, well. I just can't part with the name. I've used it twice for different concepts and see no reason to be rid of it. Sword in Board Workshop will be the hub for my projects, as both a publishing entity and a host for smaller items.

What have I learned so far? I've learned that the hardest part about designing this system has been accounting for leveling up. I've learned a bit about web development and learned - repeatedly - that I have very little time at my disposal. Balance is key, as it always is. Maybe I'll dive into it at another time.  For now, I mostly wanted to get a post in, a quick note to say I'm here, there's a real person behind the nonsense.
